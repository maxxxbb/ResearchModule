...
\title{Research Project: Applied Microeconomics\thanks{Max Boehringer : Mehmet Emir Kavukcu : Lara Schorer : Maxie Schulze, Rheinische Friedrich-Wilhelms-Universität Bonn. Email: \href{mailto:s6mxboeh@uni-bonn.de}{\nolinkurl{s6mxboeh [at] uni-bonn [dot] de}}.}}

\author{Max Boehringer : Mehmet Emir Kavukcu : Lara Schorer : Maxie Schulze}
